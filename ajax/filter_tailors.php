...
try {
    ...
    foreach ($companies as $comp) {
        $formattedCompanies[] = [
            ...
            'shop_image' => $comp['logo'] ? ltrim(str_replace(['../', './'], '', $comp['logo']), '/') : 'uploads/logos/default-shop.jpg',
            'logo_image' => $comp['logo'] ? ltrim(str_replace(['../', './'], '', $comp['logo']), '/') : 'uploads/logos/default-shop.jpg',
