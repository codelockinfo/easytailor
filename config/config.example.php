...
define('APP_URL', 'http://localhost/tailoring'); // Update this to your domain
...
define('DB_NAME', 'tailoring_management');
define('DB_USER', 'root');
define('DB_PASS', '');
define('DB_CHARSET', 'utf8mb4');

// Email settings (if you plan to add email functionality)
define('SMTP_HOST', 'smtp.gmail.com');
define('SMTP_PORT', 587);
define('SMTP_USERNAME', '');
define('SMTP_PASSWORD', '');
define('SMTP_FROM_EMAIL', '');
define('SMTP_FROM_NAME', 'Tailoring Management System');
